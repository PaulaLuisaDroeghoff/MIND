...
def classify_sentence_with_fewshot(sentence_text, manip_examples, nonmanip_examples):
    """
    Classify a sentence using few-shot prompting with training examples.
    """
    schema = {
        "type": "object",
        "properties": {
...
Based on the examples provided, analyze whether the given sentence contains mental manipulation.
Consider the subtle patterns you see in the training examples.
...
Be highly sensitive to subtle emotional control tactics as shown in the examples."""

    user_prompt = create_fewshot_prompt(manip_examples, nonmanip_examples, sentence_text)
...
if __name__ == "__main__":
    ...
    run_improved_sentence_classification(
        ...
        output_file='manipulation_results_chatgpt_fewshot.json',
