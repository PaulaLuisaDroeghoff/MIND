...
def classify_dialogue_with_fewshot(dialogue_text, manip_examples, nonmanip_examples):
    """
    Classify a dialogue using zero-shot prompting (changed from few-shot).
    """
    schema = {
        "type": "object",
        "properties": {
...
Analyze whether the given dialogue contains mental manipulation based on the definition and characteristics provided above.
...
4. Look at the overall conversational dynamic, not just individual sentences"""
    ...
    user_prompt = f"Now analyze this dialogue:\n{dialogue_text}\n\nIs this dialogue manipulative or non-manipulative? Consider the overall conversational dynamic and psychological impact."
