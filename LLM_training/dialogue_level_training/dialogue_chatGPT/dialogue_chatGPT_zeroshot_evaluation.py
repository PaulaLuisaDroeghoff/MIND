...
def compare_dialogue_gpt_to_original(gpt_results_file, excel_file, dialogue_column, label_column):
    ...
    with open('chatGPT_dialogue_zeroshot_evaluation.json', 'w') as f:
        json.dump(matched_data, f, indent=2, ensure_ascii=False)

    print(f"Saved {len(matched_data)} matched dialogues to 'chatGPT_dialogue_zeroshot_evaluation.json'")
    ...
    return {
        ...
        'confusion_matrix': cm,
        'matched_data_file': 'chatGPT_dialogue_zeroshot_evaluation.json'
    }
...
if __name__ == "__main__":
    ...
    gpt_file = "/Users/pauladroghoff/Documents/UCL/COMP0177-Project/MasterThesis/Code/LLM_training/dialogue_level_training/dialogue_chatGPT/dialogue_manipulation_results_zeroshot_balanced.json"
