...
# Your dialogue level model results data
data = {
    'Model': [
    ...
    'Precision': [0.679, 0.684, 0.545, 0.543, 0.568, 0.585],
    'Recall': [0.718, 0.867, 0.960, 1.000, 0.577, 0.596],
    'F1-Score': [0.718, 0.729, 0.696, 0.704, 0.571, 0.589]
}
...
fig.update_layout(
    polar=dict(
        radialaxis=dict(
            visible=True,
            range=[0.5, 1.0],  # Focus on the actual data range
            tickmode='linear',
            tick0=0.5,
    ...
    title=dict(
        text='<b>Dialogue Level Model Results Comparison</b>',
        x=0.5,
        y=0.95,
...
fig.write_image("dialogue_radar_plot_full.png", width=800, height=600, scale=2)

# Optional: Save as HTML for interactivity
fig.write_html("dialogue_radar_plot_full.html")

# Create and save the simplified top-3 plot
print("=" * 60)
print("DIALOGUE LEVEL MODEL PERFORMANCE SUMMARY")
print("=" * 60)
...
# Create a simpler version with fewer models (top 3 performers by F1-Score)
print("\n" + "=" * 60)
...
fig_simple.update_layout(
    polar=dict(
        radialaxis=dict(
            visible=True,
            range=[0.5, 1.0],  # Focus on actual data range
            tickmode='linear',
            tick0=0.5,
            dtick=0.05,
            tickfont=dict(size=12, color='black', family='Arial'),
    ...
    title=dict(
        text='<b>Top 3 Dialogue Level Models Performance</b>',
        x=0.5,
        y=0.95,
...
fig.write_image("dialogue_radar_plot_full.png", width=800, height=600, scale=2)
fig_simple.write_image("dialogue_radar_plot_top3.png", width=700, height=700, scale=2)

# Optional: Save as HTML for interactivity
fig.write_html("dialogue_radar_plot_full.html")
fig_simple.write_html("dialogue_radar_plot_top3.html")

print("Files saved:")
print("- dialogue_radar_plot_full.png (all 6 models)")
print("- dialogue_radar_plot_top3.png (top 3 models)")
print("- dialogue_radar_plot_full.html (interactive version - all models)")
print("- dialogue_radar_plot_top3.html (interactive version - top 3 models)")

print("\nKey Insights from Dialogue Level Results:")
print("- ChatGPT Zero-Shot achieves perfect recall (1.000) - captures all manipulative dialogues")
print("- Iterative Feedback Agent shows best F1-Score (0.729) with balanced performance")
print("- ChatGPT models excel at recall but have lower precision (more false positives)")
print("- Traditional ML models (Random Forest, Logistic Regression) show consistent lower performance")
print("- The dialogue level task appears more challenging than sentence-level for precision")